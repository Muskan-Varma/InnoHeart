...
<body>
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h2>Upload Craft</h2>
            <label for="title" style="margin-bottom: 15px; width: calc(100% / 2 - 20px);">Title:</label><br>
            <input type="text" id="title" name="title" style="margin-bottom: 15px; width: calc(100% / 2 - 20px);" required><br><br>
