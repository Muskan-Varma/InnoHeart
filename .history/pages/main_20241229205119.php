    ...
    <section id="playarea">  
      ...
      <section id="content-section">
         <?php foreach ($crafts as $row): ?>
            <div class="card" data-subcategory="<?php echo htmlspecialchars($row['category']); ?>">
                  ...
                  <div class="product-details">
                     ...
                     <div class="product-bottom-details">
                           ...
                           <div class="product-links">
                              <br>
                              <a href="#" onclick="addToFavourites(<?php echo $row['cid']; ?>)"><i class="fa fa-heart"></i></a>
