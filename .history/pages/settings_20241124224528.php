...
<body>
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h2>Account Settings</h2><br>
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px;" name="updateProfile">Update Profile</button>
                </div>
            </div>
        </form>
    </section>
    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        <form>
            ...
            <form method="post" action="settings.php">
                <input type="hidden" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px;"name="craft_id" value="<?php echo htmlspecialchars($craft['cid']); ?>">
                <button type="button" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px;" onclick="showUpdateForm(<?php echo htmlspecialchars(json_encode($craft)); ?>)">Update Craft</button>
            </form>
