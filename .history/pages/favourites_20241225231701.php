                ...
                <div class="product-details">
                    ...
                    <div class="product-bottom-details">
                        ...
                        <div class="product-links">
                            <!-- Buy button -->
                            <button style="color: white; text-align: center; cursor: pointer; background: linear-gradient(135deg, #0905db, #55acfd" class="buy-btn" onclick="showSellerDetails(<?php echo $row['cid']; ?>)">Buy</button>
                        </div>
                    </div>
