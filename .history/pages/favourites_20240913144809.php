...
if (isset($_SESSION['username'])) {
    ...
    // Corrected SQL query to match the proper column name in the 'favourites' table
    $sql = "SELECT f.cid AS favourite_craft_id, c.*, u.firstName, u.email, u.phone 
    FROM favourites f
                ...
                <div class="product-details">
                    ...
                    <div class="product-bottom-details">
                        ...
                        <div class="product-links">
                            <!-- Buy button -->
                            <button class="buy-btn" onclick="showSellerDetails(<?php echo $row['favourite_craft_id']; ?>)">Buy</button>
                        </div>
                    </div>
                    <div class="seller-details" id="seller-<?php echo $row['favourite_craft_id']; ?>" style="display: none;">
