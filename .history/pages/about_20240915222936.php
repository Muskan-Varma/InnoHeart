...
<body>
    ...
    <div class="team-container">
        <div class="image-slider" data-index="0">
            <img src="../img/img1.jpeg" alt="Craft Image" style="display: block;">
            <img src="../img/img2.jpeg" alt="Craft Image" style="display: none;">
            <img src="../img/img3.jpeg" alt="Craft Image" style="display: none;">
            <img src="../img/img3.jpeg" alt="Craft Image" style="display: none;">
            <img src="../img/img4.jpeg" alt="Craft Image" style="display: none;">
            <img src="../img/img5.jpeg" alt="Craft Image" style="display: none;">
            <img src="../img/img6.jpeg" alt="Craft Image" style="display: none;">
            <img src="../img/img7.jpeg" alt="Craft Image" style="display: none;">
            <!-- More images -->
            <button class="prev" onclick="changeImage(this, -1)">&#10094;</button>
            <button class="next" onclick="changeImage(this, 1)">&#10095;</button>
        </div>
        <div class="image-slider" data-index="0">
            <img src="uploads/ganesha.jfif" alt="Craft Image" style="display: block;">
            <img src="uploads/ganesha1.jfif" alt="Craft Image" style="display: none;">
            <!-- More images -->
            <button class="prev" onclick="changeImage(this, -1)">&#10094;</button>
            <button class="next" onclick="changeImage(this, 1)">&#10095;</button>
        </div>
    ...
    <script type="text/javascript">
        ...
        function changeImage(button, direction) {
            ...
            // Display the selected image and hide others
        ...
        function autoScrollImages(sliderIndex) {
            const slider = document.querySelector(`.image-slider[data-index="${sliderIndex}"]`);
            const images = slider.querySelectorAll('img');
            ...
            autoScrollIntervals[sliderIndex] = setInterval(() => {
                currentImageIndices[sliderIndex] = (currentImageIndices[sliderIndex] + 1) % images.length;
        ...
        // Initialize the auto-scrolling for all sliders
        function initAutoScroll() {
            const sliders = document.querySelectorAll('.image-slider');
            sliders.forEach((slider, index) => {
                autoScrollImages(index);
            });
        }

        // Call the initAutoScroll function when the page loads
        window.onload = initAutoScroll;
