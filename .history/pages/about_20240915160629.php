...
<body>
    <section class="about-section">
        <div class="about-header">
            ...
            <p></p>Our mission is to empower individuals by providing a simple and user-friendly platform to display and sell their handmade crafts. Unlike other platforms, we eliminate the complexities and let your talent speak for itself.</p>
        </div>
