...
if (isset($_SESSION['username'])) {
    ...
    $sql = "SELECT f.craft_id, c.*, u.firstName, u.email, u.phone FROM favourites f JOIN craft c ON f.craft_id = c.cid JOIN users u ON c.uploader_id = u.uidWHERE f.user_id = ?";
