...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['updateProfile'])) {
        ...
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssdiii", $title, $description, $price, $quantity, $craft_id, $user['uid']); // Updated binding
        ...
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssdi", $title, $description, $price, $quantity, $craft_id, $user['uid']);
        $stmt->execute();
        $stmt->close();
