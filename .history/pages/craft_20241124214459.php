    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h2>Upload Craft</h2><br>
            <div class="user-details">
                ...
                <label for="images">Upload Images:</label><br><br>
                <input type="file" id="images" name="images[]" multiple="multiple" required>
                <br><br><br>

                <div class="input-box">
                    <input type="submit" value="Add Craft" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px;">
                </div>
            </div>
        </form>
    </section>
