...
<body>
    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        <form>
            ...
            <form method="post" action="settings.php" style="width: 150px;">
                <input type="hidden" name="craft_id" value="<?php echo htmlspecialchars($craft['cid']); ?>">
                <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px;" name="deleteCraft" onclick="return confirm('Are you sure you want to delete this craft?')">Delete Craft</button>
            </form>
        </div>
        <?php endforeach; ?>
