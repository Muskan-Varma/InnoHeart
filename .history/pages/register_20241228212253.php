...
<body>
    ...
    <?php 
        if ($showAlert) { 
            ...
            echo "<script>alert('<strong>Success!</strong> Your account is now created and you can login."');</script>";
        } 
        ...
        if ($showError) { 
             ...
             */
            echo "<script>alert('<strong>Error!</strong>  " . $showError . "');</script>";
        } 
        ...
        if ($exists) { 
            ...
            */
            echo "<script>alert('<strong>Error!</strong>  " . $exists . "');</script>";
        }
    ?> 
