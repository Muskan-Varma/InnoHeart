...
<body>
    ...
    <section class="craft-details">
        <h1 style="text-transform: uppercase; font-size: 30px; margin-left: 5%; color:rgb(255, 204, 19);"><?php echo htmlspecialchars($craft['title']); ?></h1>
        <div class="details-container">
            ...
            <div class="info-section">
                ...
                <br><hr><br>
                <h3 style="font-size:20px; color: #ff1361;">Seller Details</h3>
