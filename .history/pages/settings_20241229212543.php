    ...
    <section id="playarea" style="display: flex; flex-wrap: wrap; gap: 20px; margin: 50px;">
        ...
        <form>
            ...
            <form method="post" action="settings.php" style="padding:0; width: 150px;">
                ...
                <button class="supdate" type="button" onclick="showUpdateForm(<?php echo htmlspecialchars(json_encode($craft)); ?>)">Update Craft</button>
            </form>

            <form method="post" action="settings.php" style="padding:0; width: 150px;">
                <input type="hidden" name="craft_id" value="<?php echo htmlspecialchars($craft['cid']); ?>">
                <button class="supdate" type="submit" name="deleteCraft" onclick="return confirm('Are you sure you want to delete this craft?')">Delete Craft</button>
            </form>
        </div>
        <?php endforeach; ?>
