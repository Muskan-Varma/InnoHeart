...
if (isset($_SESSION['username'])) { 
  ...
  $stmt = $conn->prepare("SELECT craft.cid, craft.subcategory, craft.posted_date, craft.title, craft.description, craft.quantity, craft.price, images.image_path FROM craft 
