...
<body>
    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h3>Delete Account</h3>
            <div class="user-details">
                <div class="input-box">
                    <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px;" name="deleteAccount" onclick="return confirm('Are you sure you want to delete your account? This action cannot be undone.')">Delete Account</button>
                </div>
            </div>
        </form>
    </section>
