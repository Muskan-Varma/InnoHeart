...
<body>
                ...
                <div class="product-details">
                    ...
                    <div class="product-bottom-details">
                        ...
                        <div class="product-links">
                            <!-- Buy button -->
                            <button style="padding: 20px;font-size: 16px; color: white; text-align: center; cursor: pointer; background: linear-gradient(135deg, #0905db, #55acfd);" class="buy-btn" onclick="showSellerDetails(<?php echo $row['cid']; ?>)">Buy</button>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function showSellerDetails(cid) {
            ...
            // Toggle visibility
            if (sellerDetails.style.display === 'none' || sellerDetails.style.display === '') {
                sellerDetails.style.display = 'block';  // Show seller details
            } else {
                sellerDetails.style.display = 'none';   // Hide seller details if already visible
            }
        }
