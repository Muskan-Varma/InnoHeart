...
<body>
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h2>Account Settings</h2><br>
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:10px; font-size:16px; border-radius: 8px;" name="updateProfile">Update Profile</button>
                </div>
            </div>
        </form>
    </section>
    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        <form>
            ...
            <form method="post" action="settings.php" style="padding:0width: 150px;">
                <input type="hidden" name="craft_id" value="<?php echo htmlspecialchars($craft['cid']); ?>">
                <button type="button" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:10px; font-size:16px; border-radius: 8px;" onclick="showUpdateForm(<?php echo htmlspecialchars(json_encode($craft)); ?>)">Update Craft</button>
            </form>

            <form method="post" action="settings.php" style="width: 150px;">
                <input type="hidden" name="craft_id" value="<?php echo htmlspecialchars($craft['cid']); ?>">
                <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:10px; font-size:16px; border-radius: 8px;" name="deleteCraft" onclick="return confirm('Are you sure you want to delete this craft?')">Delete Craft</button>
            </form>
        </div>
        <?php endforeach; ?>
        ...
        <div id="updateForm" style="display:none;">
            ...
            <h2>Update Craft</h2>
                <div class="user-details">
                    ...
                    <div class="input-box">
                        <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:10px; font-size:16px; border-radius: 8px;" name="updateCraft">Update Craft</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h3>Change Password</h3>
            <div class="user-details">
                ...
                <div class="input-box">
                    <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:10px; font-size:16px; border-radius: 8px;" name="changePassword">Change Password</button>
                </div>
            </div>
        </form>
    </section>
    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h3>Delete Account</h3>
            <div class="user-details">
                <div class="input-box">
                    <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:10px; font-size:16px; border-radius: 8px;" name="deleteAccount" onclick="return confirm('Are you sure you want to delete your account? This action cannot be undone.')">Delete Account</button>
                </div>
            </div>
        </form>
    </section>
