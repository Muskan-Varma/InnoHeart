    ...
    <section id="playarea" style="padding-left : 100px; padding-right : 100px;">
        ...
        <h2>Account Settings</h2><br>
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    <button type="submit" style="background:linear-gradient(135deg, #5db5ef, #f0f5c4); width: 150px; padding:20px; font-size:16px;" name="updateProfile">Update Profile</button>
                </div>
            </div>
        </form>
    </section>
